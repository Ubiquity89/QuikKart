  ...
  return (
    ...
    <div className='bg-white max-w-4xl w-full p-4 rounded'>
        ...
        <form className='my-3 grid gap-2' onSubmit={handleSubmit}>
            ...
            <div className='grid gap-1'>
                ...
                <div className='flex gap-4 flex-col lg:flex-row items-center'>
                    ...
                    <label htmlFor='uploadCategoryImage'>
                        ...
                        <input disabled={!categoryData.name} onChange={handleUploadCategoryImage} type='file' id='uploadCategoryImage' className='hidden'/>
                    </label>
            ...
            <button
                className={`
                ${categoryData.name && categoryData.image ? "bg-primary-200 hover:bg-primary-100" : "bg-gray-300 "}
                py-2    
                font-semibold 
                `}
