...
const EditProductAdmin = ({ close ,data : propsData,fetchProductData}) => {
  const [data, setData] = useState({
    ...
    category: Array.isArray(propsData.category) ? propsData.category : (propsData.category && propsData.category._id ? [propsData.category] : []),
    subCategory: Array.isArray(propsData.subCategory) ? propsData.subCategory : (propsData.subCategory && propsData.subCategory._id ? [propsData.subCategory] : []),
    unit: propsData.unit,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Prepare data for API - extract ObjectId from category and subCategory
      ...
      const apiData = {
        ...
        subCategory: getSubCategoryValue(data.subCategory)
      }
