...
export async function logoutController(request,response){
    try {
        ...
        console.log('Attempting to clear cookies and update user');
        ...
        console.log('Updating user refresh_token to empty for userId:', userid);
...
export async function uploadAvatar(request, response) {
  ...
  try {
    ...
    // Ensure uploadImageCloudinary returns { url: ... }
